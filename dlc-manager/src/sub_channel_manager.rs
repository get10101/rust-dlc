    ...
    F::Target: FeeEstimator,
{
    ...
    fn on_sub_channel_close_accept(
        ...
        log::debug!("on_subchannel_close_accept: 8");

        self.dlc_channel_manager
            .get_store()
            .persist_chain_monitor(&self.dlc_channel_manager.get_chain_monitor().lock().unwrap())?;

        log::debug!("on_subchannel_close_accept: done");
    ...
    fn on_sub_channel_close_finalize(
        ...
        log::debug!("Enter on_subchannel_close_finalize");
        ...
        log::debug!("on_subchannel_close_finalize: 1");
        ...
        log::debug!("on_subchannel_close_finalize: 2");
        ...
        log::debug!("on_subchannel_close_finalize: 3");

        let (dlc_channel, contract) = self
            .dlc_channel_manager
            .get_closed_sub_dlc_channel(dlc_channel_id, state.own_balance)?;

        log::debug!("on_subchannel_close_finalize: 4");
        ...
        log::debug!("on_subchannel_close_finalize: 5");
        ...
        log::debug!("on_subchannel_close_finalize: 6");

        self.dlc_channel_manager
            .get_store()
            .upsert_sub_channel(&sub_channel)?;

        log::debug!("on_subchannel_close_finalize: done");
